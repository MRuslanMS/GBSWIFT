...
//  VKProject1
//
//  Created by xc553a8 on 30.08.2021.
//
...
class GroupTableViewController: UITableViewController {
    ...
    private func writeNewGroupToFirebase(_ newGroup: Group){
        // работаем с Firebase
        let database = Database.database(url: "https://vkproject1-926a9-default-rtdb.europe-west1.firebasedatabase.app/").reference(withPath: "groups")
        let ref: DatabaseReference = database.child(String(Session.instance.userId))
