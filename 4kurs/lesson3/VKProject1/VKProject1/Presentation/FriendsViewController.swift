...
//  VKProject1
//
//  Created by xc553a8 on 2021-08-19.
//
...
class FriendsViewController: UITableViewController, UISearchBarDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.avatarFriendImage.avatarImage.kf.indicatorType = .activity
        cell.avatarFriendImage.avatarImage.kf.setImage(with: avatar)
