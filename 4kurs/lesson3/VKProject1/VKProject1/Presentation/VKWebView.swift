...
//  VKProject1
//
//  Created by xc553a8 on 26.09.2021.
//
...
final class VKWebView: UIViewController {
...
//    lazy var ref: DatabaseReference = self.database.reference(withPath: "All logged users")
    ...
    func loadAuthVK() {
        ...
        urlConstructor.queryItems = [
            URLQueryItem(name: "client_id", value: "113929439"),
...
extension VKWebView : WKNavigationDelegate {
